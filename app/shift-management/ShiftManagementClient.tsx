...
// Props
// ---------------------------------------------------------------------------
export interface ShiftManagementClientProps {
...
// Main component
// ---------------------------------------------------------------------------
export default function ShiftManagementClient({ initialAppointments, allEmployees }: ShiftManagementClientProps) {
  // ── sidebar ──
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-start justify-between mb-8">
            <div>
              ...
              <p className="text-slate-500 mt-1">Manage service bookings, assign staff, and track shift completion</p>
            </div>
            <button
              type="button"
